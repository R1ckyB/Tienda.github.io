...
`,_e={success:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m9 11 3 3L22 4"/></svg>`,error:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/></svg>`,warning:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`,info:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`},ve=null;function ye(){if(!ve){let e=document.createElement(`style`);e.textContent=ge,document.head.appendChild(e),ve=document.createElement(`div`),ve.className=`toast-container`,document.body.appendChild(ve)}}function I(e,t,n=``,r=4e3){ye();let i=document.createElement(`div`);return i.className=`toast ${e}`,i.innerHTML=`
  ...
  `,i.querySelector(`.toast-close`).addEventListener(`click`,()=>be(i)),ve.appendChild(i),r>0&&setTimeout(()=>be(i),r),i}function be(e){!e||!e.parentElement||(e.classList.add(`removing`),setTimeout(()=>e.remove(),300))}var xe=`
.modal-backdrop {
  position: fixed;
  inset: 0;
...
`,Se=!1;function Ce(){if(!Se){let e=document.createElement(`style`);e.textContent=xe,document.head.appendChild(e),Se=!0}}function we({title:e,content:t,size:n=``,footer:r=``,onClose:i=null}){Ce();let a=document.createElement(`div`);a.className=`modal-backdrop`,a.innerHTML=`
  ...
  `;let o=()=>{a.classList.add(`closing`),setTimeout(()=>{a.remove(),i&&i()},200)};return a.querySelector(`.modal-close`).addEventListener(`click`,o),a.addEventListener(`click`,e=>{e.target===a&&o()}),document.body.appendChild(a),{element:a,close:o}}function L({title:e,message:t,type:n=`danger`,confirmText:r=`Confirmar`,cancelText:i=`Cancelar`}){return new Promise(a=>{let o={danger:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`,warning:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`},s=we({title:``,content:`
    ...
    `}function s(){if(t===1){let e=document.getElementById(`setup-name`),a=document.getElementById(`setup-next`);e?.addEventListener(`input`,e=>{n=e.target.value.trim(),a.disabled=!n}),a?.addEventListener(`click`,()=>{n&&(t=2,r=``,i())}),e?.addEventListener(`keydown`,e=>{e.key===`Enter`&&n&&(t=2,r=``,i())})}t===2&&Ae(async e=>{try{(await j.setupOwner(n,e)).success&&(I(`success`,`¡Bienvenida!`,`Tu tienda está lista, ${n}`),M.navigate(`/dashboard`))}catch(e){document.getElementById(`pin-error`).textContent=e.message,r=``,R(r)}},e=>{r=e})}i()}async function De(e){let t=await O.getActive(),n=null,r=``;function i(){let e=document.getElementById(`app`);e.className=``,e.innerHTML=`
      <div class="login-page">
        <div class="login-container">
          <div class="login-header">
            <div class="login-logo">🏪</div>
      ...
      <div class="login-user-select">
        ${t.map(e=>`
          <div class="login-user-option" data-user-id="${e.id}">
            ...
            <span style="margin-left:auto; color: var(--text-muted);">${N(`chevron-right`)}</span>
          </div>
        `).join(``)}
      </div>
    `}function o(){return`
      ...
      ${Oe(r)}
      <p class="pin-error-msg" id="pin-error"></p>
    `}function s(){n?(document.getElementById(`back-to-users`)?.addEventListener(`click`,()=>{n=null,r=``,i()}),Ae(async e=>{let t=await j.login(e);if(t.success)I(`success`,`¡Hola, ${t.user.name}!`),M.navigate(`/dashboard`);else{let e=document.getElementById(`pin-error`);e&&(e.textContent=`PIN incorrecto`),r=``,R(r),document.querySelectorAll(`.pin-dot`).forEach(e=>{e.classList.add(`error`),setTimeout(()=>e.classList.remove(`error`),600)})}},e=>{r=e})):document.querySelectorAll(`.login-user-option`).forEach(e=>{e.addEventListener(`click`,()=>{let a=parseInt(e.dataset.userId);n=t.find(e=>e.id===a),r=``,i()})})}i()}function Oe(e){return`
  ...
  `}function R(e){document.querySelectorAll(`.pin-dot`).forEach((t,n)=>{t.classList.toggle(`filled`,n<e.length)})}var ke=null;function Ae(e,t){let n=``;ke&&ke.abort(),ke=new AbortController,document.querySelectorAll(`.pin-key`).forEach(r=>{r.addEventListener(`click`,()=>{let i=r.dataset.key;i===`clear`?n=``:i===`delete`?n=n.slice(0,-1):n.length<4&&(n+=i),t(n),R(n);let a=document.getElementById(`pin-error`);a&&(a.textContent=``),n.length===4&&setTimeout(()=>e(n),200)})}),document.addEventListener(`keydown`,r=>{if(!document.querySelector(`.pin-keypad`)){ke.abort();return}r.key>=`0`&&r.key<=`9`&&n.length<4?(n+=r.key,t(n),R(n),n.length===4&&setTimeout(()=>e(n),200)):r.key===`Backspace`&&(n=n.slice(0,-1),t(n),R(n))},{signal:ke.signal})}async function je(e){let t=await E.getStats(),n=await re.getRecent(8),r=await E.getLowStock(),i=await re.getDailyStats(7);await D.getAll();let a=await E.getAll(),o={};a.forEach(e=>{o[e.id]=e});for(let e of n)e.productName=o[e.productId]?.name||`Producto eliminado`;let s=Math.max(...i.map(e=>e.total),1);e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
        <h1 class="page-title">¡Hola, ${j.getUserName()}! 👋</h1>
        <p class="page-subtitle">Resumen de tu tienda</p>
      </div>
    </div>
    ...
    <div class="dashboard-stats">
      <div class="stat-card fade-in-up stagger-1">
        <div class="stat-icon primary">${N(`package`)}</div>
        <div class="stat-info">
          <span class="stat-value">${ce(t.totalProducts)}</span>
      ...
      <div class="stat-card fade-in-up stagger-2" ${t.lowStockCount>0?`style="border-color: var(--danger); cursor:pointer;" onclick="location.hash='#/inventory?filter=lowstock'"`:``}>
        <div class="stat-icon danger">${N(`alert-triangle`)}</div>
        <div class="stat-info">
          <span class="stat-value">${ce(t.lowStockCount)}</span>
          <span class="stat-label">Stock Bajo</span>
        </div>
      </div>

      <div class="stat-card fade-in-up stagger-3">
        <div class="stat-icon secondary">${N(`dollar-sign`)}</div>
        <div class="stat-info">
          <span class="stat-value">${se(t.totalValueSale)}</span>
          <span class="stat-label">Valor Inventario</span>
        </div>
      </div>

      <div class="stat-card fade-in-up stagger-4">
        <div class="stat-icon info">${N(`trending-up`)}</div>
        <div class="stat-info">
          <span class="stat-value">${se(t.potentialProfit)}</span>
    ...
    <div class="dashboard-grid">
      ...
      <div class="card fade-in-up stagger-3">
        <div class="card-header">
          ...
          <span class="badge badge-neutral">${N(`bar-chart`)} Actividad</span>
        </div>
          ...
          <div class="chart-bars">
            ${i.map(e=>`
              <div class="chart-bar-wrapper">
                ...
                <div class="chart-bar" style="height: ${Math.max(e.total/s*100,3)}%;" data-tooltip="Entradas: ${e.entries} | Salidas: ${e.exits}"></div>
          ...
          `:n.map(e=>`
            <div class="activity-item">
              <div class="activity-icon ${e.type}">
                ${N(e.type===`entry`?`arrow-down`:`arrow-up`)}
              </div>
              <div class="activity-text">
                ...
                <span>${e.reason} · ${le(e.createdAt)}</span>
              </div>
            </div>
          `).join(``)}
        </div>
      ...
      <div class="card fade-in-up stagger-5" style="margin-top: var(--space-md); border-color: rgba(231, 111, 81, 0.3);">
        <div class="card-header">
          <h3 class="card-title" style="color: var(--danger);">
            ${N(`alert-triangle`)} Productos con Stock Bajo
          </h3>
  ...
  `,e.querySelectorAll(`.restock-btn`).forEach(e=>{e.addEventListener(`click`,()=>{M.navigate(`/movements?product=${e.dataset.id}&type=entry`)})})}var z=`modulepreload`,Me=function(e){return`/`+e},Ne={},Pe=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=Me(t,n),t in Ne)return;Ne[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:z,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},B={search:``,categoryId:null,lowStock:!1,sortBy:`name`,sortDir:`asc`};async function Fe(e,t={}){let n=t.query;n&&n.get(`filter`)===`lowstock`&&(B.lowStock=!0),await Ie(e)}async function Ie(e){let t=await D.getAll(),n=await E.getAll(B);e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
      ...
      <div class="page-actions">
        ${j.isOwner()?`
          <button class="btn btn-secondary" id="export-csv-btn">
            ${N(`download`)} <span class="hide-mobile">Exportar</span>
          </button>
        `:``}
        <button class="btn btn-primary" id="add-product-btn">
          ${N(`plus`)} Nuevo Producto
        </button>
      </div>
    </div>
    ...
    <div class="toolbar fade-in-up stagger-1">
      <div class="search-box">
        <span class="search-icon">${N(`search`)}</span>
    ...
    ${n.length===0?`
      <div class="empty-state fade-in-up stagger-2">
        <div class="empty-state-icon">${N(`package`)}</div>
        ...
        ${!B.search&&!B.categoryId?`
          <button class="btn btn-primary" onclick="location.hash='#/products/new'">${N(`plus`)} Agregar Producto</button>
        `:`
          <button class="btn btn-secondary" id="clear-filters-btn">${N(`refresh`)} Limpiar filtros</button>
        `}
      </div>
    `:`
      <div class="table-wrapper fade-in-up stagger-2">
        <table class="data-table" id="products-table">
          <thead>
            <tr>
              <th class="sortable ${B.sortBy===`name`?`sorted-`+B.sortDir:``}" data-sort="name">
                Producto ${B.sortBy===`name`?B.sortDir===`asc`?`↑`:`↓`:``}
              </th>
              <th class="hide-mobile sortable ${B.sortBy===`categoryId`?`sorted-`+B.sortDir:``}" data-sort="categoryId">
                Categoría ${B.sortBy===`categoryId`?B.sortDir===`asc`?`↑`:`↓`:``}
              </th>
              <th class="sortable ${B.sortBy===`stock`?`sorted-`+B.sortDir:``}" data-sort="stock">
                Stock ${B.sortBy===`stock`?B.sortDir===`asc`?`↑`:`↓`:``}
              </th>
              <th class="hide-mobile sortable ${B.sortBy===`purchasePrice`?`sorted-`+B.sortDir:``}" data-sort="purchasePrice">
                P. Compra ${B.sortBy===`purchasePrice`?B.sortDir===`asc`?`↑`:`↓`:``}
              </th>
              <th class="sortable ${B.sortBy===`salePrice`?`sorted-`+B.sortDir:``}" data-sort="salePrice">
                P. Venta ${B.sortBy===`salePrice`?B.sortDir===`asc`?`↑`:`↓`:``}
              </th>
    ...
    `}
  `,Re(e,t)}function Le(e,t){let n={};return t.forEach(e=>{n[e.id]=e}),e.map(e=>{let t=n[e.categoryId],r=e.stock<e.minStock,i=e.stock===0;return`
      <tr data-product-id="${e.id}">
        ...
        <td class="hide-mobile">${se(e.purchasePrice)}</td>
        <td>${se(e.salePrice)}</td>
        <td>
    ...
    `}).join(``)}function Re(e,t){let n=e.querySelector(`#search-input`),r=de(async t=>{B.search=t,await Ie(e)},300);n?.addEventListener(`input`,e=>r(e.target.value)),e.querySelector(`#category-filter`)?.addEventListener(`change`,async t=>{B.categoryId=t.target.value?parseInt(t.target.value):null,await Ie(e)}),e.querySelector(`#lowstock-filter`)?.addEventListener(`click`,async()=>{B.lowStock=!B.lowStock,await Ie(e)}),e.querySelector(`#clear-filters-btn`)?.addEventListener(`click`,async()=>{B={search:``,categoryId:null,lowStock:!1,sortBy:`name`,sortDir:`asc`},await Ie(e)}),e.querySelectorAll(`.sortable`).forEach(t=>{t.style.cursor=`pointer`,t.addEventListener(`click`,async()=>{let n=t.dataset.sort;B.sortBy===n?B.sortDir=B.sortDir===`asc`?`desc`:`asc`:(B.sortBy=n,B.sortDir=`asc`),await Ie(e)})}),e.querySelector(`#add-product-btn`)?.addEventListener(`click`,()=>{M.navigate(`/products/new`)}),e.querySelector(`#export-csv-btn`)?.addEventListener(`click`,async()=>{let{SettingsAPI:e}=await Pe(async()=>{let{SettingsAPI:e}=await Promise.resolve().then(()=>ee);return{SettingsAPI:e}},void 0),t=await e.exportCSV(),{downloadFile:n}=await Pe(async()=>{let{downloadFile:e}=await Promise.resolve().then(()=>oe);return{downloadFile:e}},void 0);n(t,`inventario_dona_marian_${new Date().toISOString().split(`T`)[0]}.csv`,`text/csv`),I(`success`,`Exportación exitosa`,`Se descargó el archivo CSV`)}),e.querySelectorAll(`.edit-btn`).forEach(e=>{e.addEventListener(`click`,()=>{M.navigate(`/products/${e.dataset.id}`)})}),e.querySelectorAll(`.delete-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{await L({title:`¿Eliminar producto?`,message:`Se eliminará "${(await E.getById(parseInt(t.dataset.id))).name}" permanentemente.`,type:`danger`,confirmText:`Eliminar`})&&(await E.delete(parseInt(t.dataset.id)),I(`success`,`Producto eliminado`),await Ie(e))})}),e.querySelectorAll(`.movement-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{await ze(parseInt(t.dataset.id),e)})})}async function ze(e,t){let n=await E.getById(e);if(!n)return;let r=`entry`,i=we({title:`Registrar Movimiento`,content:`
    ...
    <div class="form-group" style="margin-bottom: var(--space-md);">
      ...
      <select class="form-select" id="movement-reason">
        ${me.entry.map(e=>`<option value="${e}">${e}</option>`).join(``)}
      </select>
    </div>
  `,footer:`
    <button class="btn btn-secondary" id="modal-cancel">Cancelar</button>
    <button class="btn btn-primary" id="modal-save">${N(`check-circle`)} Registrar</button>
  `});i.element.querySelectorAll(`.movement-type-btn`).forEach(e=>{e.addEventListener(`click`,()=>{i.element.querySelectorAll(`.movement-type-btn`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),r=e.dataset.type;let t=i.element.querySelector(`#movement-reason`);t.innerHTML=me[r].map(e=>`<option value="${e}">${e}</option>`).join(``)})}),i.element.querySelector(`#modal-cancel`).addEventListener(`click`,()=>i.close()),i.element.querySelector(`#modal-save`).addEventListener(`click`,async()=>{let a=parseInt(i.element.querySelector(`#movement-qty`).value),o=i.element.querySelector(`#movement-reason`).value;if(!a||a<=0){I(`error`,`Cantidad inválida`,`Ingresa una cantidad mayor a 0`);return}if(r===`exit`&&a>n.stock){I(`warning`,`Stock insuficiente`,`Solo hay ${n.stock} ${n.unit||`pzas`} disponibles`);return}try{let s=(await Pe(async()=>{let{default:e}=await Promise.resolve().then(()=>ie);return{default:e}},void 0)).default;await re.register(e,r,a,o,s.getUserId()),I(`success`,r===`entry`?`Entrada registrada`:`Salida registrada`,`${a} ${n.unit||`pzas`} de ${n.name}`),i.close(),await Ie(t)}catch(e){I(`error`,`Error`,e.message)}})}async function Be(e,t={}){let n=t.id&&t.id!==`new`,r=n?await E.getById(parseInt(t.id)):null,i=await D.getAll();if(n&&!r){I(`error`,`Producto no encontrado`),M.navigate(`/inventory`);return}e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
      ...
      <form class="product-form" id="product-form">
        ...
        <div style="display: flex; gap: var(--space-sm); justify-content: flex-end; padding-top: var(--space-md); border-top: 1px solid var(--border-color);">
          ...
          <button type="submit" class="btn btn-primary btn-lg">
            ${N(`save`)} ${n?`Guardar Cambios`:`Crear Producto`}
          </button>
        </div>
      </form>
    </div>
  `;let a=e.querySelector(`#product-form`),o=e.querySelector(`#product-purchase`),s=e.querySelector(`#product-sale`),c=e.querySelector(`#margin-indicator`);function l(){let e=parseFloat(o.value)||0,t=parseFloat(s.value)||0;if(e>0&&t>0){let n=((t-e)/e*100).toFixed(1),r=n>=0?`var(--success)`:`var(--danger)`;c.innerHTML=`Margen: <strong style="color: ${r};">${n}%</strong> (Ganancia: <strong style="color: ${r};">$${(t-e).toFixed(2)}</strong>)`}else c.innerHTML=``}o?.addEventListener(`input`,l),s?.addEventListener(`input`,l),l(),e.querySelector(`#cancel-btn`)?.addEventListener(`click`,()=>M.navigate(`/inventory`)),e.querySelector(`#form-cancel`)?.addEventListener(`click`,()=>M.navigate(`/inventory`)),a?.addEventListener(`submit`,async i=>{i.preventDefault();let a={name:e.querySelector(`#product-name`).value.trim(),barcode:e.querySelector(`#product-barcode`).value.trim(),categoryId:parseInt(e.querySelector(`#product-category`).value),purchasePrice:parseFloat(e.querySelector(`#product-purchase`).value)||0,salePrice:parseFloat(e.querySelector(`#product-sale`).value)||0,stock:n?r.stock:parseInt(e.querySelector(`#product-stock`).value)||0,minStock:parseInt(e.querySelector(`#product-minstock`).value)||5,unit:e.querySelector(`#product-unit`).value,supplier:e.querySelector(`#product-supplier`).value.trim(),notes:e.querySelector(`#product-notes`).value.trim()};if(!a.name){I(`error`,`Nombre requerido`);return}if(!a.categoryId){I(`error`,`Selecciona una categoría`);return}try{n?(await E.update(parseInt(t.id),a),I(`success`,`Producto actualizado`,a.name)):(await E.create(a),I(`success`,`Producto creado`,a.name)),M.navigate(`/inventory`)}catch(e){I(`error`,`Error`,e.message)}})}async function Ve(e){let t=await D.getAllIncludeInactive();for(let e of t)e.productCount=await D.getProductCount(e.id);e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
  ...
  `,e.querySelector(`#add-category-btn`)?.addEventListener(`click`,()=>{He(null,e)}),e.querySelectorAll(`.edit-cat-btn`).forEach(t=>{t.addEventListener(`click`,async n=>{n.stopPropagation(),He(await D.getById(parseInt(t.dataset.id)),e)})}),e.querySelectorAll(`.delete-cat-btn`).forEach(t=>{t.addEventListener(`click`,async n=>{n.stopPropagation();let r=parseInt(t.dataset.id);if(await L({title:`¿Eliminar categoría?`,message:`Se eliminará "${(await D.getById(r)).name}". Los productos sin categoría quedarán sin asignar.`,type:`danger`,confirmText:`Eliminar`}))try{await D.delete(r),I(`success`,`Categoría eliminada`),await Ve(e)}catch(e){I(`error`,`No se pudo eliminar`,e.message)}})})}function He(e,t){let n=!!e,r=e?.color||he[0],i=`
    <div class="form-group" style="margin-bottom: var(--space-lg);">
  ...
  `,a=`
    ...
    <button class="btn btn-primary" id="cat-save">${N(`save`)} ${n?`Guardar`:`Crear`}</button>
  `,o=we({title:n?`Editar Categoría`:`Nueva Categoría`,content:i,footer:a,size:`sm`});o.element.querySelectorAll(`.color-option`).forEach(e=>{e.addEventListener(`click`,()=>{o.element.querySelectorAll(`.color-option`).forEach(e=>e.style.borderColor=`transparent`),e.style.borderColor=`var(--text-primary)`,r=e.dataset.color})}),o.element.querySelector(`#cat-cancel`).addEventListener(`click`,()=>o.close()),o.element.querySelector(`#cat-save`).addEventListener(`click`,async()=>{let i=o.element.querySelector(`#cat-name`).value.trim();if(!i){I(`error`,`Nombre requerido`);return}try{n?(await D.update(e.id,{name:i,color:r}),I(`success`,`Categoría actualizada`)):(await D.create({name:i,color:r}),I(`success`,`Categoría creada`)),o.close(),await Ve(t)}catch(e){I(`error`,`Error`,e.message)}})}var V={type:``,productId:``,dateFrom:``,dateTo:``};async function Ue(e){let t=window.location.hash,n=new URLSearchParams(t.split(`?`)[1]||``);n.get(`product`)&&(V.productId=n.get(`product`)),n.get(`type`)&&(V.type=n.get(`type`)),await H(e)}async function H(e){let t=await re.getAll(V),n=await E.getAll({showInactive:!0}),r=await O.getAll(),i={};n.forEach(e=>{i[e.id]=e});let a={};r.forEach(e=>{a[e.id]=e});let o=t.map(e=>({...e,productName:i[e.productId]?.name||`Eliminado`,productUnit:i[e.productId]?.unit||`pzas`,userName:a[e.userId]?.name||`—`})),s=await re.getAll({}),c=s.filter(e=>e.type===`entry`).reduce((e,t)=>e+t.quantity,0),l=s.filter(e=>e.type===`exit`).reduce((e,t)=>e+t.quantity,0),u=V.type||V.productId||V.dateFrom||V.dateTo;e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
        <h1 class="page-title">Movimientos de Stock</h1>
        <p class="page-subtitle">${o.length} movimiento${o.length===1?``:`s`} ${u?`(filtrados)`:`registrados`}</p>
      </div>
      ${u?`
        <div class="page-actions">
          <button class="btn btn-secondary btn-sm" id="clear-movement-filters">
            ${N(`refresh`)} Limpiar filtros
          </button>
        </div>
      `:``}
    </div>
    ...
    <div style="display: flex; gap: var(--space-md); margin-bottom: var(--space-lg); flex-wrap: wrap;" class="fade-in-up stagger-1">
      <div style="display: flex; align-items: center; gap: var(--space-xs); padding: var(--space-sm) var(--space-md); background: var(--success-bg); border-radius: var(--radius-md);">
        ${N(`arrow-down`)}
        <span style="color: var(--success); font-weight: var(--font-weight-semibold);">Entradas: ${c}</span>
      </div>
      <div style="display: flex; align-items: center; gap: var(--space-xs); padding: var(--space-sm) var(--space-md); background: var(--danger-bg); border-radius: var(--radius-md);">
        ${N(`arrow-up`)}
        <span style="color: var(--danger); font-weight: var(--font-weight-semibold);">Salidas: ${l}</span>
      </div>
    </div>

    <!-- Filters -->
    <div class="toolbar fade-in-up stagger-1" style="margin-bottom: var(--space-md);">
      <div class="filter-group" style="flex-wrap: wrap; width: 100%; gap: var(--space-sm);">
        <select class="form-select" id="movement-type-filter" style="min-width: 130px; max-width: 180px;">
          <option value="">Todos los tipos</option>
          <option value="entry" ${V.type===`entry`?`selected`:``}>📥 Entradas</option>
          <option value="exit" ${V.type===`exit`?`selected`:``}>📤 Salidas</option>
        </select>
        <select class="form-select" id="movement-product-filter" style="min-width: 150px; max-width: 220px;">
          <option value="">Todos los productos</option>
          ${n.filter(e=>e.active).map(e=>`
            <option value="${e.id}" ${V.productId==e.id?`selected`:``}>${e.name}</option>
          `).join(``)}
        </select>
        <input type="date" class="form-input" id="movement-date-from" value="${V.dateFrom}" 
          style="max-width: 160px;" placeholder="Desde">
        <input type="date" class="form-input" id="movement-date-to" value="${V.dateTo}" 
          style="max-width: 160px;" placeholder="Hasta">
      </div>
    </div>

    ${o.length===0?`
      <div class="empty-state fade-in-up stagger-2">
        <div class="empty-state-icon">${N(`arrow-left-right`)}</div>
        <h3 class="empty-state-title">${u?`Sin resultados`:`Sin movimientos`}</h3>
        <p class="empty-state-text">${u?`Intenta con otros filtros`:`Los movimientos de stock aparecerán aquí cuando registres entradas o salidas`}</p>
        ${u?`
          <button class="btn btn-secondary" id="clear-movement-filters-empty">${N(`refresh`)} Limpiar filtros</button>
        `:``}
      </div>
    `:`
      <div class="table-wrapper fade-in-up stagger-2">
            ...
            ${o.map(e=>`
              <tr>
                ...
                <td style="font-size: var(--font-size-sm); color: var(--text-secondary);">
                  <span data-tooltip="${ue(e.createdAt)}">${le(e.createdAt)}</span>
                </td>
              </tr>
            `).join(``)}
          </tbody>
    ...
    `}
  `,e.querySelector(`#movement-type-filter`)?.addEventListener(`change`,async t=>{V.type=t.target.value,await H(e)}),e.querySelector(`#movement-product-filter`)?.addEventListener(`change`,async t=>{V.productId=t.target.value,await H(e)}),e.querySelector(`#movement-date-from`)?.addEventListener(`change`,async t=>{V.dateFrom=t.target.value,await H(e)}),e.querySelector(`#movement-date-to`)?.addEventListener(`change`,async t=>{V.dateTo=t.target.value,await H(e)});let d=async()=>{V={type:``,productId:``,dateFrom:``,dateTo:``},await H(e)};e.querySelector(`#clear-movement-filters`)?.addEventListener(`click`,d),e.querySelector(`#clear-movement-filters-empty`)?.addEventListener(`click`,d)}async function U(e){if(!j.isOwner()){e.innerHTML=`
      <div class="empty-state">
        <div class="empty-state-icon" style="background: var(--danger-bg); color: var(--danger);">${N(`shield`)}</div>
        <h3 class="empty-state-title">Acceso restringido</h3>
        <p class="empty-state-text">Solo la dueña puede gestionar usuarios</p>
      </div>
    `;return}let t=await O.getAll();e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
            ...
            ${e.role===`owner`?``:`
              <div style="display: flex; gap: var(--space-2xs);">
                ...
                <button class="btn btn-icon btn-ghost toggle-user-btn" data-id="${e.id}" data-active="${e.active}" data-tooltip="${e.active?`Desactivar`:`Activar`}" style="color: ${e.active?`var(--danger)`:`var(--success)`};">
                  ${e.active?N(`circle-x`):N(`check-circle`)}
                </button>
              </div>
            `}
          </div>
  ...
  `,e.querySelector(`#add-user-btn`)?.addEventListener(`click`,()=>{W(null,e)}),e.querySelectorAll(`.edit-user-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{W(await O.getById(parseInt(t.dataset.id)),e)})}),e.querySelectorAll(`.toggle-user-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let n=parseInt(t.dataset.id),r=await O.getById(n);r.active?await L({title:`¿Desactivar usuario?`,message:`${r.name} no podrá acceder a la app.`,type:`warning`,confirmText:`Desactivar`})&&(await O.update(n,{active:!1}),I(`success`,`Usuario desactivado`),await U(e)):(await O.update(n,{active:!0}),I(`success`,`Usuario activado`),await U(e))})})}function W(e,t){let n=!!e,r=`
    <div class="form-group" style="margin-bottom: var(--space-md);">
  ...
  `,i=`
    ...
    <button class="btn btn-primary" id="user-save">${N(`save`)} ${n?`Guardar`:`Crear`}</button>
  `,a=we({title:n?`Editar Empleado`:`Nuevo Empleado`,content:r,footer:i,size:`sm`});a.element.querySelector(`#user-cancel`).addEventListener(`click`,()=>a.close()),a.element.querySelector(`#user-save`).addEventListener(`click`,async()=>{let r=a.element.querySelector(`#user-name`).value.trim(),i=a.element.querySelector(`#user-pin`).value.trim();if(!r){I(`error`,`Nombre requerido`);return}if(!n&&(!i||i.length!==4||!/^\d{4}$/.test(i))){I(`error`,`PIN inválido`,`Debe ser de 4 dígitos numéricos`);return}if(n&&i&&(i.length!==4||!/^\d{4}$/.test(i))){I(`error`,`PIN inválido`,`Debe ser de 4 dígitos numéricos`);return}try{if(n){let t={name:r};i&&(t.pin=i),await O.update(e.id,t),I(`success`,`Empleado actualizado`)}else await O.create({name:r,pin:i,role:`employee`}),I(`success`,`Empleado creado`,`PIN: ${i}`);a.close(),await U(t)}catch(e){I(`error`,`Error`,e.message)}})}async function We(e){let t=await k.getAll();e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
    ...
    <div class="card fade-in-up stagger-1" style="margin-bottom: var(--space-md);">
      <div class="card-header">
        <h3 class="card-title">${N(`store`)} Datos de la Tienda</h3>
      </div>
      <div style="display: flex; flex-direction: column; gap: var(--space-md);">
        <div class="form-group">
          <label class="form-label">Nombre de la tienda</label>
          <input type="text" class="form-input" id="setting-store-name" value="${t.storeName||`Doña Marian`}" ${j.isOwner()?``:`disabled`}>
        </div>
        <div class="form-group">
          <label class="form-label">Nombre de la dueña</label>
          <input type="text" class="form-input" id="setting-owner-name" value="${t.ownerName||``}" ${j.isOwner()?``:`disabled`}>
        </div>
        ${j.isOwner()?`
          <button class="btn btn-primary" id="save-settings-btn" style="align-self: flex-start;">
            ${N(`save`)} Guardar Cambios
          </button>
        `:``}
      </div>
    </div>
    ...
    ${j.isOwner()?`
      <div class="card fade-in-up stagger-2" style="margin-bottom: var(--space-md);">
        <div class="card-header">
          <h3 class="card-title">${N(`database`)} Respaldos</h3>
        </div>
        <div class="settings-group">
          <div class="settings-item">
            <div class="settings-item-info">
              <div class="settings-item-icon">${N(`download`)}</div>
          ...
          <div class="settings-item">
            <div class="settings-item-info">
              <div class="settings-item-icon" style="background: var(--warning-bg); color: var(--warning);">${N(`upload`)}</div>
              <div class="settings-item-text">
  ...
  `;function n(){let t=e.querySelector(`#connection-status`),n=e.querySelector(`#connection-text`);t&&n&&(navigator.onLine?(t.style.background=`var(--success)`,n.textContent=`Conectado`):(t.style.background=`var(--warning)`,n.textContent=`Sin conexión — datos guardados localmente`))}n(),window.addEventListener(`online`,n),window.addEventListener(`offline`,n),e.querySelector(`#save-settings-btn`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#setting-store-name`).value.trim(),n=e.querySelector(`#setting-owner-name`).value.trim();await k.set(`storeName`,t||`Doña Marian`),await k.set(`ownerName`,n),I(`success`,`Configuración guardada`);let r=document.querySelector(`.sidebar-brand-name`);r&&(r.textContent=t||`Doña Marian`)}),e.querySelector(`#export-backup-btn`)?.addEventListener(`click`,async()=>{try{let e=await k.exportAll(),t=new Date().toISOString().split(`T`)[0];F(e,`dona_marian_backup_${t}.json`,`application/json`),I(`success`,`Respaldo exportado`,`Guarda este archivo en un lugar seguro`)}catch(e){I(`error`,`Error al exportar`,e.message)}}),e.querySelector(`#import-backup-btn`)?.addEventListener(`click`,async()=>{try{let e=await fe(`.json`);await k.importAll(e),I(`success`,`Respaldo restaurado`,`Se recargará la app...`),setTimeout(()=>location.reload(),1500)}catch(e){I(`error`,`Error al importar`,e.message)}}),e.querySelector(`#export-csv-btn`)?.addEventListener(`click`,async()=>{try{let e=await k.exportCSV(),t=new Date().toISOString().split(`T`)[0];F(e,`inventario_dona_marian_${t}.csv`,`text/csv`),I(`success`,`CSV exportado`)}catch(e){I(`error`,`Error al exportar`,e.message)}})}function Ge(){let e=j.getUser(),t=document.getElementById(`app`);t.innerHTML=`
      ...
      <div class="sidebar-footer">
        <div class="sidebar-user" id="user-menu">
          ...
          <div class="sidebar-user-info">
            ...
            <span class="sidebar-user-role">${j.getUserRole()}</span>
          </div>
    ...
    <main class="main-content">
      <header class="main-header">
        ...
        <div class="header-right">
          <div id="offline-indicator" style="display:none; color: var(--warning); font-size: var(--font-size-sm); align-items: center; gap: var(--space-2xs);">
            ${N(`wifi-off`)} Sin conexión
          </div>
        </div>
      </header>
    ...
    <div class="offline-banner" id="offline-banner">
      ${N(`wifi-off`)} Sin conexión — los datos se guardan localmente
    </div>
  `;let n=document.getElementById(`sidebar`),r=document.getElementById(`sidebar-overlay`);document.getElementById(`hamburger-btn`)?.addEventListener(`click`,()=>{n.classList.toggle(`open`),r.classList.toggle(`open`),r.classList.toggle(`visible`)}),r?.addEventListener(`click`,()=>{n.classList.remove(`open`),r.classList.remove(`open`),r.classList.remove(`visible`)}),document.getElementById(`logout-btn`)?.addEventListener(`click`,()=>{j.logout(),M.navigate(`/login`)});function i(){let e=`/`+M.getCurrentPath().split(`/`)[1];document.querySelectorAll(`.nav-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),document.querySelectorAll(`.bottom-nav-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),n?.classList.remove(`open`),r?.classList.remove(`open`,`visible`);let t={"/dashboard":`Dashboard`,"/inventory":`Inventario`,"/categories":`Categorías`,"/movements":`Movimientos`,"/users":`Usuarios`,"/settings":`Configuración`,"/products":`Producto`},i=document.getElementById(`header-title`);i&&(i.textContent=t[e]||`Doña Marian`)}window.addEventListener(`hashchange`,i),i();function a(){let e=document.getElementById(`offline-banner`),t=document.getElementById(`offline-indicator`);navigator.onLine?(e?.classList.remove(`visible`),t&&(t.style.display=`none`)):(e?.classList.add(`visible`),t&&(t.style.display=`flex`))}window.addEventListener(`online`,a),window.addEventListener(`offline`,a),a(),Ke()}async function Ke(){try{let{ProductsAPI:e}=await Pe(async()=>{let{ProductsAPI:e}=await Promise.resolve().then(()=>ee);return{ProductsAPI:e}},void 0),t=await e.getLowStock(),n=document.getElementById(`low-stock-badge`);n&&(t.length>0?(n.textContent=t.length,n.style.display=`flex`):n.style.display=`none`)}catch{}}async function qe(){if(await ne(),M.register({"/login":e=>Te(e),"/dashboard":e=>je(e),"/inventory":e=>Fe(e),"/products/new":e=>Be(e,{id:`new`}),"/products/:id":(e,t)=>Be(e,t),"/categories":e=>Ve(e),"/movements":e=>Ue(e),"/users":e=>U(e),"/settings":e=>We(e)}),M.setGuard(async e=>{let t=`/`+e.split(`/`).filter(Boolean)[0];return t===`/login`?!0:j.isLoggedIn()?!(!j.isOwner()&&t===`/users`):(M.navigate(`/login`),!1)}),await j.init()?(Ge(),!window.location.hash||window.location.hash===`#/login`?M.navigate(`/dashboard`):M.start()):(M.navigate(`/login`),M.start()),j.onChange(e=>{e&&(Ge(),M.start())}),`serviceWorker`in navigator)try{let e=await navigator.serviceWorker.register(`/sw.js`);console.log(`Service Worker registered:`,e.scope)}catch(e){console.log(`SW registration failed:`,e)}}var Je=document.createElement(`style`);Je.textContent=`
...
`,document.head.appendChild(Je),qe();