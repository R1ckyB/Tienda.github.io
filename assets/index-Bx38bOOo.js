...
`,Se={success:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m9 11 3 3L22 4"/></svg>`,error:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/></svg>`,warning:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`,info:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`},Ce=null;function we(){if(!Ce){let e=document.createElement(`style`);e.textContent=xe,document.head.appendChild(e),Ce=document.createElement(`div`),Ce.className=`toast-container`,document.body.appendChild(Ce)}}function I(e,t,n=``,r=4e3){we();let i=document.createElement(`div`);return i.className=`toast ${e}`,i.innerHTML=`
  ...
  `,i.querySelector(`.toast-close`).addEventListener(`click`,()=>Te(i)),Ce.appendChild(i),r>0&&setTimeout(()=>Te(i),r),i}function Te(e){!e||!e.parentElement||(e.classList.add(`removing`),setTimeout(()=>e.remove(),300))}var Ee=`
.modal-backdrop {
  position: fixed;
  inset: 0;
...
`,De=!1;function Oe(){if(!De){let e=document.createElement(`style`);e.textContent=Ee,document.head.appendChild(e),De=!0}}function ke({title:e,content:t,size:n=``,footer:r=``,onClose:i=null}){Oe();let a=document.createElement(`div`);a.className=`modal-backdrop`,a.innerHTML=`
  ...
  `;let o=()=>{a.classList.add(`closing`),setTimeout(()=>{a.remove(),i&&i()},200)};return a.querySelector(`.modal-close`).addEventListener(`click`,o),a.addEventListener(`click`,e=>{e.target===a&&o()}),document.body.appendChild(a),{element:a,close:o}}function L({title:e,message:t,type:n=`danger`,confirmText:r=`Confirmar`,cancelText:i=`Cancelar`}){return new Promise(a=>{let o={danger:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`,warning:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`},s=ke({title:``,content:`
    ...
    `}function s(){if(t===1){let e=document.getElementById(`setup-name`),a=document.getElementById(`setup-next`);e?.addEventListener(`input`,e=>{n=e.target.value.trim(),a.disabled=!n}),a?.addEventListener(`click`,()=>{n&&(t=2,r=``,i())}),e?.addEventListener(`keydown`,e=>{e.key===`Enter`&&n&&(t=2,r=``,i())})}t===2&&Me(async e=>{try{(await A.setupOwner(n,e)).success&&(I(`success`,`¡Bienvenida!`,`Tu tienda está lista, ${n}`),j.navigate(`/dashboard`))}catch(e){document.getElementById(`pin-error`).textContent=e.message,r=``,B(r)}},e=>{r=e})}i()}async function R(e){let t=await D.getActive(),n=null,r=``;function i(){let e=document.getElementById(`app`);e.className=``,e.innerHTML=`
      <div class="login-page">
        <div class="login-container">
          <div class="login-header">
            <div class="login-logo">🏪</div>
    ...
    `}function o(){return`
      ...
      ${z(r)}
      <p class="pin-error-msg" id="pin-error"></p>
    `}function s(){n?(document.getElementById(`back-to-users`)?.addEventListener(`click`,()=>{n=null,r=``,i()}),Me(async e=>{let t=await A.login(e);if(t.success)I(`success`,`¡Hola, ${t.user.name}!`),j.navigate(`/dashboard`);else{let e=document.getElementById(`pin-error`);e&&(e.textContent=`PIN incorrecto`),r=``,B(r),document.querySelectorAll(`.pin-dot`).forEach(e=>{e.classList.add(`error`),setTimeout(()=>e.classList.remove(`error`),600)})}},e=>{r=e})):document.querySelectorAll(`.login-user-option`).forEach(e=>{e.addEventListener(`click`,()=>{let a=parseInt(e.dataset.userId);n=t.find(e=>e.id===a),r=``,i()})})}i()}function z(e){return`
  ...
  `}function B(e){document.querySelectorAll(`.pin-dot`).forEach((t,n)=>{t.classList.toggle(`filled`,n<e.length)})}function Me(e,t){let n=``;document.querySelectorAll(`.pin-key`).forEach(r=>{r.addEventListener(`click`,()=>{let i=r.dataset.key;i===`clear`?n=``:i===`delete`?n=n.slice(0,-1):n.length<4&&(n+=i),t(n),B(n);let a=document.getElementById(`pin-error`);a&&(a.textContent=``),n.length===4&&setTimeout(()=>e(n),200)})}),document.addEventListener(`keydown`,function r(i){if(!document.querySelector(`.pin-keypad`)){document.removeEventListener(`keydown`,r);return}i.key>=`0`&&i.key<=`9`&&n.length<4?(n+=i.key,t(n),B(n),n.length===4&&setTimeout(()=>e(n),200)):i.key===`Backspace`&&(n=n.slice(0,-1),t(n),B(n))})}async function Ne(e){let t=await w.getStats(),n=await T.getRecent(8),r=await w.getLowStock(),i=await T.getDailyStats(7),a=await E.getAll(),o=await w.getAll();for(let e of n)e.productName=(await w.getById(e.productId))?.name||`Producto eliminado`;let s=Math.max(...i.map(e=>e.total),1);e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
        <h1 class="page-title">¡Hola, ${A.getUserName()}! 👋</h1>
    ...
    <div class="dashboard-stats">
      <div class="stat-card fade-in-up stagger-1">
        ...
        <div class="stat-info">
          <span class="stat-value">${de(t.totalProducts)}</span>
      ...
      <div class="stat-card fade-in-up stagger-2" ${t.lowStockCount>0?`style="border-color: var(--danger); cursor:pointer;" onclick="location.hash='#/inventory?filter=lowstock'"`:``}>
        ...
        <div class="stat-info">
          <span class="stat-value">${de(t.lowStockCount)}</span>
      ...
      <div class="stat-card fade-in-up stagger-3">
        ...
        <div class="stat-info">
          <span class="stat-value">${ue(t.totalValueSale)}</span>
      ...
      <div class="stat-card fade-in-up stagger-4">
        ...
        <div class="stat-info">
          <span class="stat-value">${ue(t.potentialProfit)}</span>
    ...
    <div class="dashboard-grid">
      ...
      <div class="card fade-in-up stagger-4">
        <div class="card-header">
          <h3 class="card-title">Inversión por Categoría</h3>
          <span class="badge badge-neutral">${M(`pie-chart`)} Inventario</span>
        </div>
        <div class="category-distribution">
          ${a.map(e=>{let n=o.filter(t=>t.categoryId===e.id),r=n.reduce((e,t)=>e+t.purchasePrice*t.stock,0),i=n.reduce((e,t)=>e+t.stock,0),a=t.totalValuePurchase>0?r/t.totalValuePurchase*100:0;return i===0?``:`
              <div class="dist-item">
                <div class="dist-info">
                  <span class="dist-dot" style="background: ${e.color};"></span>
                  <span class="dist-name">${e.name}</span>
                  <span class="dist-value">${ue(r)}</span>
                </div>
                <div class="dist-progress-bg">
                  <div class="dist-progress-bar" style="width: ${a}%; background: ${e.color};"></div>
                </div>
              </div>
            `}).join(``)}
        </div>
  ...
  `,e.querySelectorAll(`.restock-btn`).forEach(e=>{e.addEventListener(`click`,()=>{j.navigate(`/movements?product=${e.dataset.id}&type=entry`)})})}var V={search:``,categoryId:null,lowStock:!1,sortBy:`name`,sortDir:`asc`},Pe=!1;async function Fe(e){window.location.hash.includes(`filter=lowstock`)&&(V.lowStock=!0),Pe||=(be(t=>{let n=document.getElementById(`search-input`);n&&(n.value=t,V.search=t,H(e),I(`info`,`Código escaneado`,t))}),!0),await H(e)}async function H(e){let t=await E.getAll(),n=await w.getAll(V);e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
      ...
      <div class="page-actions">
        ${A.isOwner()?`
          <button class="btn btn-secondary" id="export-pdf-btn">
            ${M(`file-text`)} <span class="hide-mobile">Reporte PDF</span>
          </button>
          <button class="btn btn-secondary" id="export-csv-btn">
            ${M(`download`)} <span class="hide-mobile">CSV</span>
          </button>
        `:``}
    ...
    <div class="toolbar fade-in-up stagger-1">
      <div class="search-box">
        ...
        <input type="text" class="form-input" id="search-input" placeholder="Buscar producto..." value="${V.search||``}">
      </div>
      <div class="filter-group">
        <select class="form-select" id="category-filter" style="min-width:140px;">
          <option value="">Todas las categorías</option>
          ${t.map(e=>`
            <option value="${e.id}" ${V.categoryId===e.id?`selected`:``}>${e.name}</option>
          `).join(``)}
        </select>
        <button class="btn btn-sm ${V.lowStock?`btn-danger`:`btn-secondary`}" id="lowstock-filter">
    ...
    ${n.length===0?`
      <div class="empty-state fade-in-up stagger-2">
        ...
        <h3 class="empty-state-title">${V.search||V.categoryId||V.lowStock?`Sin resultados`:`Sin productos`}</h3>
        <p class="empty-state-text">${V.search||V.categoryId||V.lowStock?`Intenta con otros filtros`:`Agrega tu primer producto para empezar`}</p>
        ${!V.search&&!V.categoryId?`
    ...
    `}
  `,Le(e,t)}async function Ie(e,t){let n={};return t.forEach(e=>{n[e.id]=e}),e.map(e=>{let t=n[e.categoryId],r=e.stock<e.minStock,i=e.stock===0;return`
      <tr data-product-id="${e.id}">
        ...
        <td class="hide-mobile">${ue(e.purchasePrice)}</td>
        <td>${ue(e.salePrice)}</td>
        <td>
    ...
    `}).join(``)}function Le(e,t){let n=e.querySelector(`#search-input`),r=pe(async t=>{V.search=t,await H(e)},300);n?.addEventListener(`input`,e=>r(e.target.value)),e.querySelector(`#category-filter`)?.addEventListener(`change`,async t=>{V.categoryId=t.target.value?parseInt(t.target.value):null,await H(e)}),e.querySelector(`#lowstock-filter`)?.addEventListener(`click`,async()=>{V.lowStock=!V.lowStock,await H(e)}),e.querySelector(`#clear-filters-btn`)?.addEventListener(`click`,async()=>{V={search:``,categoryId:null,lowStock:!1,sortBy:`name`,sortDir:`asc`},await H(e)}),e.querySelector(`#add-product-btn`)?.addEventListener(`click`,()=>{j.navigate(`/products/new`)}),e.querySelector(`#export-csv-btn`)?.addEventListener(`click`,async()=>{let{SettingsAPI:e}=await ce(async()=>{let{SettingsAPI:e}=await Promise.resolve().then(()=>te);return{SettingsAPI:e}},void 0),t=await e.exportCSV(),{downloadFile:n}=await ce(async()=>{let{downloadFile:e}=await Promise.resolve().then(()=>le);return{downloadFile:e}},void 0);n(t,`inventario_dona_marian_${new Date().toISOString().split(`T`)[0]}.csv`,`text/csv`),I(`success`,`Exportación exitosa`,`Se descargó el archivo CSV`)}),e.querySelector(`#export-pdf-btn`)?.addEventListener(`click`,async()=>{let e=await w.getAll(V),n={};t.forEach(e=>{n[e.id]=e.name});let r=[`Producto`,`Categoría`,`Stock`,`P. Venta`],i=e.map(e=>[e.name,n[e.categoryId]||`Sin categoría`,`${e.stock} ${e.unit||`pzas`}`,ue(e.salePrice)]);await F({title:`Reporte de Inventario — Doña Marian`,filename:`inventario_${new Date().toISOString().split(`T`)[0]}`,headers:r,rows:i}),I(`success`,`PDF generado correctamente`)}),e.querySelectorAll(`.edit-btn`).forEach(e=>{e.addEventListener(`click`,()=>{j.navigate(`/products/${e.dataset.id}`)})}),e.querySelectorAll(`.delete-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{await L({title:`¿Eliminar producto?`,message:`Se eliminará "${(await w.getById(parseInt(t.dataset.id))).name}" permanentemente.`,type:`danger`,confirmText:`Eliminar`})&&(await w.delete(parseInt(t.dataset.id)),I(`success`,`Producto eliminado`),await H(e))})}),e.querySelectorAll(`.movement-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{await Re(parseInt(t.dataset.id),e)})})}async function Re(e,t){let n=await w.getById(e);if(!n)return;let r=`entry`,i=ke({title:`Registrar Movimiento`,content:`
  ...
  `;let a=e.querySelector(`#product-form`),o=e.querySelector(`#product-purchase`),s=e.querySelector(`#product-sale`),c=e.querySelector(`#margin-indicator`);function l(){let e=parseFloat(o.value)||0,t=parseFloat(s.value)||0,n=ye(e,t);if(e>0&&t>0){let r=n>=0?`var(--success)`:`var(--danger)`;c.innerHTML=`Margen: <strong style="color: ${r};">${n.toFixed(1)}%</strong> (Ganancia: <strong style="color: ${r};">$${(t-e).toFixed(2)}</strong>)`}else c.innerHTML=``}o?.addEventListener(`input`,l),s?.addEventListener(`input`,l),l(),e.querySelector(`#cancel-btn`)?.addEventListener(`click`,()=>j.navigate(`/inventory`)),e.querySelector(`#form-cancel`)?.addEventListener(`click`,()=>j.navigate(`/inventory`)),a?.addEventListener(`submit`,async i=>{i.preventDefault();let a={name:e.querySelector(`#product-name`).value.trim(),barcode:e.querySelector(`#product-barcode`).value.trim(),categoryId:parseInt(e.querySelector(`#product-category`).value),purchasePrice:parseFloat(e.querySelector(`#product-purchase`).value)||0,salePrice:parseFloat(e.querySelector(`#product-sale`).value)||0,stock:n?r.stock:parseInt(e.querySelector(`#product-stock`).value)||0,minStock:parseInt(e.querySelector(`#product-minstock`).value)||5,unit:e.querySelector(`#product-unit`).value,supplier:e.querySelector(`#product-supplier`).value.trim(),notes:e.querySelector(`#product-notes`).value.trim()};if(!a.name){I(`error`,`Nombre requerido`);return}if(!a.categoryId){I(`error`,`Selecciona una categoría`);return}try{n?(await w.update(parseInt(t.id),a),I(`success`,`Producto actualizado`,a.name)):(await w.create(a),I(`success`,`Producto creado`,a.name)),j.navigate(`/inventory`)}catch(e){I(`error`,`Error`,e.message)}})}async function Be(e){let t=await E.getAllIncludeInactive();for(let e of t)e.productCount=await E.getProductCount(e.id);e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
  ...
  `,o=ke({title:n?`Editar Categoría`:`Nueva Categoría`,content:i,footer:a,size:`sm`});o.element.querySelectorAll(`.color-option`).forEach(e=>{e.addEventListener(`click`,()=>{o.element.querySelectorAll(`.color-option`).forEach(e=>e.style.borderColor=`transparent`),e.style.borderColor=`var(--text-primary)`,r=e.dataset.color})}),o.element.querySelector(`#cat-cancel`).addEventListener(`click`,()=>o.close()),o.element.querySelector(`#cat-save`).addEventListener(`click`,async()=>{let i=o.element.querySelector(`#cat-name`).value.trim();if(!i){I(`error`,`Nombre requerido`);return}try{n?(await E.update(e.id,{name:i,color:r}),I(`success`,`Categoría actualizada`)):(await E.create({name:i,color:r}),I(`success`,`Categoría creada`)),o.close(),await Be(t)}catch(e){I(`error`,`Error`,e.message)}})}async function He(e){let t=await T.getAll(),n=await w.getAll({showInactive:!0}),r=await D.getAll(),i={};n.forEach(e=>{i[e.id]=e});let a={};r.forEach(e=>{a[e.id]=e});let o=t.map(e=>({...e,productName:i[e.productId]?.name||`Eliminado`,productUnit:i[e.productId]?.unit||`pzas`,userName:a[e.userId]?.name||`—`})),s=o.filter(e=>e.type===`entry`).reduce((e,t)=>e+t.quantity,0),c=o.filter(e=>e.type===`exit`).reduce((e,t)=>e+t.quantity,0);e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
            ...
            ${o.map(e=>`
              <tr>
                ...
                <td style="font-size: var(--font-size-sm); color: var(--text-secondary);">
                  <span data-tooltip="${fe(e.createdAt)}">${N(e.createdAt)}</span>
                </td>
              </tr>
            `).join(``)}
          </tbody>
    ...
    `}
  `}async function Ue(e){if(!A.isOwner()){e.innerHTML=`
  ...
  `,e.querySelector(`#add-user-btn`)?.addEventListener(`click`,()=>{U(null,e)}),e.querySelectorAll(`.edit-user-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{U(await D.getById(parseInt(t.dataset.id)),e)})}),e.querySelectorAll(`.toggle-user-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let n=parseInt(t.dataset.id),r=await D.getById(n);r.active?await L({title:`¿Desactivar usuario?`,message:`${r.name} no podrá acceder a la app.`,type:`warning`,confirmText:`Desactivar`})&&(await D.update(n,{active:!1}),I(`success`,`Usuario desactivado`),await Ue(e)):(await D.update(n,{active:!0}),I(`success`,`Usuario activado`),await Ue(e))})})}function U(e,t){let n=!!e,r=`
    <div class="form-group" style="margin-bottom: var(--space-md);">
  ...
  `,a=ke({title:n?`Editar Empleado`:`Nuevo Empleado`,content:r,footer:i,size:`sm`});a.element.querySelector(`#user-cancel`).addEventListener(`click`,()=>a.close()),a.element.querySelector(`#user-save`).addEventListener(`click`,async()=>{let r=a.element.querySelector(`#user-name`).value.trim(),i=a.element.querySelector(`#user-pin`).value.trim();if(!r){I(`error`,`Nombre requerido`);return}if(!n&&(!i||i.length!==4||!/^\d{4}$/.test(i))){I(`error`,`PIN inválido`,`Debe ser de 4 dígitos numéricos`);return}if(n&&i&&(i.length!==4||!/^\d{4}$/.test(i))){I(`error`,`PIN inválido`,`Debe ser de 4 dígitos numéricos`);return}try{if(n){let t={name:r};i&&(t.pin=i),await D.update(e.id,t),I(`success`,`Empleado actualizado`)}else await D.create({name:r,pin:i,role:`employee`}),I(`success`,`Empleado creado`,`PIN: ${i}`);a.close(),await Ue(t)}catch(e){I(`error`,`Error`,e.message)}})}async function W(e){let t=await O.getAll();e.innerHTML=`
    ...
    <div class="card fade-in-up stagger-1" style="margin-bottom: var(--space-md);">
      ...
      <div style="display: flex; flex-direction: column; gap: var(--space-md);">
        <div class="form-group">
          ...
          <input type="text" class="form-input" id="setting-store-name" value="${t.storeName||`Doña Marian`}" ${A.isOwner()?``:`disabled`}>
        </div>
        <div class="form-group">
          <label class="form-label">Nombre de la dueña</label>
          <input type="text" class="form-input" id="setting-owner-name" value="${t.ownerName||``}" ${A.isOwner()?``:`disabled`}>
        </div>
        ${A.isOwner()?`
    ...
    <!-- Session Management -->
    <div class="card fade-in-up stagger-3" style="margin-bottom: var(--space-md);">
      <div class="card-header">
        <h3 class="card-title">${M(`log-out`)} Sesión</h3>
      </div>
      <div style="display: flex; flex-direction: column; gap: var(--space-sm);">
        <p style="color: var(--text-secondary); font-size: var(--font-size-sm);">
          Sesión iniciada como <strong style="color: var(--text-primary);">${A.getUserName()}</strong> (${A.getUserRole()})
        </p>
        <button class="btn btn-danger" id="settings-logout-btn" style="align-self: flex-start; gap: var(--space-xs); display: inline-flex; align-items: center;">
          ${M(`log-out`)} Cerrar Sesión / Cambiar de Usuario
        </button>
      </div>
    </div>
  ...
  `;function n(){let t=e.querySelector(`#connection-status`),n=e.querySelector(`#connection-text`);t&&n&&(navigator.onLine?(t.style.background=`var(--success)`,n.textContent=`Conectado`):(t.style.background=`var(--warning)`,n.textContent=`Sin conexión — datos guardados localmente`))}n(),window.addEventListener(`online`,n),window.addEventListener(`offline`,n),e.querySelector(`#save-settings-btn`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#setting-store-name`).value.trim(),n=e.querySelector(`#setting-owner-name`).value.trim();await O.set(`storeName`,t||`Doña Marian`),await O.set(`ownerName`,n),I(`success`,`Configuración guardada`);let r=document.querySelector(`.sidebar-brand-name`);r&&(r.textContent=t||`Doña Marian`)}),e.querySelector(`#export-backup-btn`)?.addEventListener(`click`,async()=>{try{let e=await O.exportAll(),t=new Date().toISOString().split(`T`)[0];me(e,`dona_marian_backup_${t}.json`,`application/json`),I(`success`,`Respaldo exportado`,`Guarda este archivo en un lugar seguro`)}catch(e){I(`error`,`Error al exportar`,e.message)}}),e.querySelector(`#import-backup-btn`)?.addEventListener(`click`,async()=>{try{if(!await L({title:`¿Restaurar respaldo?`,message:`Se borrarán todos los datos actuales y se reemplazarán por los del archivo seleccionado. Esta acción no se puede deshacer.`,type:`warning`,confirmText:`Restaurar Todo`}))return;let e=await he(`.json`);await O.importAll(e),I(`success`,`Respaldo restaurado`,`Se recargará la app...`),setTimeout(()=>location.reload(),1500)}catch(e){e.message!==`No se seleccionó archivo`&&I(`error`,`Error al importar`,e.message)}}),e.querySelector(`#export-csv-btn`)?.addEventListener(`click`,async()=>{try{let e=await O.exportCSV(),t=new Date().toISOString().split(`T`)[0];me(e,`inventario_dona_marian_${t}.csv`,`text/csv`),I(`success`,`CSV exportado`)}catch(e){I(`error`,`Error al exportar`,e.message)}}),e.querySelector(`#settings-logout-btn`)?.addEventListener(`click`,()=>{A.logout(),router.navigate(`/login`)})}function We(){let e=A.getUser(),t=document.getElementById(`app`);t.innerHTML=`
      ...
      <div class="sidebar-footer">
        <div class="sidebar-user" id="user-menu">
          ...
          <div class="sidebar-user-info">
            ...
            <span class="sidebar-user-role">${A.getUserRole()}</span>
          </div>
  ...
  `;let n=document.getElementById(`sidebar`),r=document.getElementById(`sidebar-overlay`);document.getElementById(`hamburger-btn`)?.addEventListener(`click`,()=>{n.classList.toggle(`open`),r.classList.toggle(`open`),r.classList.toggle(`visible`)}),r?.addEventListener(`click`,()=>{n.classList.remove(`open`),r.classList.remove(`open`),r.classList.remove(`visible`)}),document.getElementById(`logout-btn`)?.addEventListener(`click`,()=>{A.logout(),j.navigate(`/login`)});function i(){let e=`/`+j.getCurrentPath().split(`/`)[1];document.querySelectorAll(`.nav-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),document.querySelectorAll(`.bottom-nav-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.route===e)}),n?.classList.remove(`open`),r?.classList.remove(`open`,`visible`);let t={"/dashboard":`Dashboard`,"/inventory":`Inventario`,"/categories":`Categorías`,"/movements":`Movimientos`,"/users":`Usuarios`,"/settings":`Configuración`,"/products":`Producto`},i=document.getElementById(`header-title`);i&&(i.textContent=t[e]||`Doña Marian`)}window.addEventListener(`hashchange`,i),i();function a(){let e=document.getElementById(`offline-banner`),t=document.getElementById(`offline-indicator`);navigator.onLine?(e?.classList.remove(`visible`),t&&(t.style.display=`none`)):(e?.classList.add(`visible`),t&&(t.style.display=`flex`))}window.addEventListener(`online`,a),window.addEventListener(`offline`,a),a(),Ge()}async function Ge(){try{let{ProductsAPI:e}=await ce(async()=>{let{ProductsAPI:e}=await Promise.resolve().then(()=>te);return{ProductsAPI:e}},void 0),t=await e.getLowStock(),n=document.getElementById(`low-stock-badge`);n&&(t.length>0?(n.textContent=t.length,n.style.display=`flex`):n.style.display=`none`)}catch{}}async function Ke(){if(await ne(),j.register({"/login":e=>Ae(e),"/dashboard":e=>Ne(e),"/inventory":e=>Fe(e),"/products/new":e=>ze(e,{id:`new`}),"/products/:id":(e,t)=>ze(e,t),"/categories":e=>Be(e),"/movements":e=>He(e),"/users":e=>Ue(e),"/settings":e=>W(e)}),j.setGuard(async e=>e===`/login`?!0:A.isLoggedIn()?!(!A.isOwner()&&e===`/users`):(j.navigate(`/login`),!1)),await A.init()?(We(),!window.location.hash||window.location.hash===`#/login`?j.navigate(`/dashboard`):j.start()):(j.navigate(`/login`),j.start()),A.onChange(e=>{e&&(We(),j.start())}),`serviceWorker`in navigator)try{let e=await navigator.serviceWorker.register(`/Tienda.github.io/sw.js`);console.log(`Service Worker registered:`,e.scope)}catch(e){console.log(`SW registration failed:`,e)}}var qe=document.createElement(`style`);qe.textContent=`
...
`,document.head.appendChild(qe),Ke();export{o as n,l as r,ce as t};