const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-BEujaUQO.js","assets/typeof-B5XbjTb1.js"])))=>i.map(i=>d[i]);
...
`,ye={success:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m9 11 3 3L22 4"/></svg>`,error:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/></svg>`,warning:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`,info:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`},be=null;function xe(){if(!be){let e=document.createElement(`style`);e.textContent=L,document.head.appendChild(e),be=document.createElement(`div`),be.className=`toast-container`,document.body.appendChild(be)}}function R(e,t,n=``,r=4e3){xe();let i=document.createElement(`div`);return i.className=`toast ${e}`,i.innerHTML=`
  ...
  `,i.querySelector(`.toast-close`).addEventListener(`click`,()=>Se(i)),be.appendChild(i),r>0&&setTimeout(()=>Se(i),r),i}function Se(e){!e||!e.parentElement||(e.classList.add(`removing`),setTimeout(()=>e.remove(),300))}var Ce=`
.modal-backdrop {
  position: fixed;
  inset: 0;
...
`,we=!1;function Te(){if(!we){let e=document.createElement(`style`);e.textContent=Ce,document.head.appendChild(e),we=!0}}function Ee({title:e,content:t,size:n=``,footer:r=``,onClose:i=null}){Te();let a=document.createElement(`div`);a.className=`modal-backdrop`,a.innerHTML=`
  ...
  `;let o=()=>{a.classList.add(`closing`),setTimeout(()=>{a.remove(),i&&i()},200)};return a.querySelector(`.modal-close`).addEventListener(`click`,o),a.addEventListener(`click`,e=>{e.target===a&&o()}),document.body.appendChild(a),{element:a,close:o}}function De({title:e,message:t,type:n=`danger`,confirmText:r=`Confirmar`,cancelText:i=`Cancelar`}){return new Promise(a=>{let o={danger:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>`,warning:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>`},s=Ee({title:``,content:`
    ...
    `}function s(){if(t===1){let e=document.getElementById(`setup-name`),a=document.getElementById(`setup-next`);e?.addEventListener(`input`,e=>{n=e.target.value.trim(),a.disabled=!n}),a?.addEventListener(`click`,()=>{n&&(t=2,r=``,i())}),e?.addEventListener(`keydown`,e=>{e.key===`Enter`&&n&&(t=2,r=``,i())})}t===2&&je(async e=>{try{(await A.setupOwner(n,e)).success&&(R(`success`,`¡Bienvenida!`,`Tu tienda está lista, ${n}`),j.navigate(`/dashboard`))}catch(e){document.getElementById(`pin-error`).textContent=e.message,r=``,B(r)}},e=>{r=e})}i()}async function Ae(e){let t=await D.getActive(),n=null,r=``;function i(){let e=document.getElementById(`app`);e.className=``,e.innerHTML=`
      <div class="login-page">
        <div class="login-container">
          <div class="login-header">
            <div class="login-logo">🏪</div>
  ...
  `}function B(e){document.querySelectorAll(`.pin-dot`).forEach((t,n)=>{t.classList.toggle(`filled`,n<e.length)})}function je(e,t){let n=``;document.querySelectorAll(`.pin-key`).forEach(r=>{r.addEventListener(`click`,()=>{let i=r.dataset.key;i===`clear`?n=``:i===`delete`?n=n.slice(0,-1):n.length<4&&(n+=i),t(n),B(n);let a=document.getElementById(`pin-error`);a&&(a.textContent=``),n.length===4&&setTimeout(()=>e(n),200)})}),document.addEventListener(`keydown`,function r(i){if(!document.querySelector(`.pin-keypad`)){document.removeEventListener(`keydown`,r);return}i.key>=`0`&&i.key<=`9`&&n.length<4?(n+=i.key,t(n),B(n),n.length===4&&setTimeout(()=>e(n),200)):i.key===`Backspace`&&(n=n.slice(0,-1),t(n),B(n))})}async function Me(e){let t=await w.getStats(),n=await T.getRecent(8),r=await w.getLowStock(),i=await T.getDailyStats(7),a=await E.getAll(),o=await w.getAll();for(let e of n)e.productName=(await w.getById(e.productId))?.name||`Producto eliminado`;let s=Math.max(...i.map(e=>e.total),1);e.innerHTML=`
    ...
    <div class="dashboard-stats">
      <div class="stat-card fade-in-up stagger-1">
        ...
        <div class="stat-info">
          <span class="stat-value">${le(t.totalProducts)}</span>
      ...
      <div class="stat-card fade-in-up stagger-2" ${t.lowStockCount>0?`style="border-color: var(--danger); cursor:pointer;" onclick="location.hash='#/inventory?filter=lowstock'"`:``}>
        ...
        <div class="stat-info">
          <span class="stat-value">${le(t.lowStockCount)}</span>
      ...
      <div class="stat-card fade-in-up stagger-3">
        ...
        <div class="stat-info">
          <span class="stat-value">${P(t.totalValueSale)}</span>
      ...
      <div class="stat-card fade-in-up stagger-4">
        ...
        <div class="stat-info">
          <span class="stat-value">${P(t.potentialProfit)}</span>
          ...
          ${a.map(e=>{let n=o.filter(t=>t.categoryId===e.id),r=n.reduce((e,t)=>e+t.purchasePrice*t.stock,0),i=n.reduce((e,t)=>e+t.stock,0),a=t.totalValuePurchase>0?r/t.totalValuePurchase*100:0;return i===0?``:`
              <div class="dist-item">
                <div class="dist-info">
                  ...
                  <span class="dist-value">${P(r)}</span>
                </div>
  ...
  `,e.querySelectorAll(`.restock-btn`).forEach(e=>{e.addEventListener(`click`,()=>{j.navigate(`/movements?product=${e.dataset.id}&type=entry`)})})}var V={search:``,categoryId:null,lowStock:!1,sortBy:`name`,sortDir:`asc`},H=!1;async function Ne(e){window.location.hash.includes(`filter=lowstock`)&&(V.lowStock=!0),H||=(_e(t=>{let n=document.getElementById(`search-input`);n&&(n.value=t,V.search=t,Pe(e),R(`info`,`Código escaneado`,t))}),!0),await Pe(e)}async function Pe(e){let t=await E.getAll(),n=await w.getAll(V);e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
    ...
    `}
  `,Ie(e,t)}async function Fe(e,t){let n={};return t.forEach(e=>{n[e.id]=e}),e.map(e=>{let t=n[e.categoryId],r=e.stock<e.minStock,i=e.stock===0;return`
      <tr data-product-id="${e.id}">
        ...
        <td class="hide-mobile">${P(e.purchasePrice)}</td>
        <td>${P(e.salePrice)}</td>
        <td>
    ...
    `}).join(``)}function Ie(e,t){let n=e.querySelector(`#search-input`),r=de(async t=>{V.search=t,await Pe(e)},300);n?.addEventListener(`input`,e=>r(e.target.value)),e.querySelector(`#category-filter`)?.addEventListener(`change`,async t=>{V.categoryId=t.target.value?parseInt(t.target.value):null,await Pe(e)}),e.querySelector(`#lowstock-filter`)?.addEventListener(`click`,async()=>{V.lowStock=!V.lowStock,await Pe(e)}),e.querySelector(`#clear-filters-btn`)?.addEventListener(`click`,async()=>{V={search:``,categoryId:null,lowStock:!1,sortBy:`name`,sortDir:`asc`},await Pe(e)}),e.querySelector(`#add-product-btn`)?.addEventListener(`click`,()=>{j.navigate(`/products/new`)}),e.querySelector(`#export-csv-btn`)?.addEventListener(`click`,async()=>{let{SettingsAPI:e}=await N(async()=>{let{SettingsAPI:e}=await Promise.resolve().then(()=>te);return{SettingsAPI:e}},void 0),t=await e.exportCSV(),{downloadFile:n}=await N(async()=>{let{downloadFile:e}=await Promise.resolve().then(()=>ce);return{downloadFile:e}},void 0);n(t,`inventario_dona_marian_${new Date().toISOString().split(`T`)[0]}.csv`,`text/csv`),R(`success`,`Exportación exitosa`,`Se descargó el archivo CSV`)}),e.querySelector(`#export-pdf-btn`)?.addEventListener(`click`,async()=>{let e=await w.getAll(V),n={};t.forEach(e=>{n[e.id]=e.name});let r=[`Producto`,`Categoría`,`Stock`,`P. Venta`],i=e.map(e=>[e.name,n[e.categoryId]||`Sin categoría`,`${e.stock} ${e.unit||`pzas`}`,P(e.salePrice)]);await ve({title:`Reporte de Inventario — Doña Marian`,filename:`inventario_${new Date().toISOString().split(`T`)[0]}`,headers:r,rows:i}),R(`success`,`PDF generado correctamente`)}),e.querySelectorAll(`.edit-btn`).forEach(e=>{e.addEventListener(`click`,()=>{j.navigate(`/products/${e.dataset.id}`)})}),e.querySelectorAll(`.delete-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{await De({title:`¿Eliminar producto?`,message:`Se eliminará "${(await w.getById(parseInt(t.dataset.id))).name}" permanentemente.`,type:`danger`,confirmText:`Eliminar`})&&(await w.delete(parseInt(t.dataset.id)),R(`success`,`Producto eliminado`),await Pe(e))})}),e.querySelectorAll(`.movement-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{await Le(parseInt(t.dataset.id),e)})})}async function Le(e,t){let n=await w.getById(e);if(!n)return;let r=`entry`,i=Ee({title:`Registrar Movimiento`,content:`
  ...
  `;let a=e.querySelector(`#product-form`),o=e.querySelector(`#product-purchase`),s=e.querySelector(`#product-sale`),c=e.querySelector(`#margin-indicator`);function l(){let e=parseFloat(o.value)||0,t=parseFloat(s.value)||0,n=calculateMargin(e,t);if(e>0&&t>0){let r=n>=0?`var(--success)`:`var(--danger)`;c.innerHTML=`Margen: <strong style="color: ${r};">${n.toFixed(1)}%</strong> (Ganancia: <strong style="color: ${r};">$${(t-e).toFixed(2)}</strong>)`}else c.innerHTML=``}o?.addEventListener(`input`,l),s?.addEventListener(`input`,l),l(),e.querySelector(`#cancel-btn`)?.addEventListener(`click`,()=>j.navigate(`/inventory`)),e.querySelector(`#form-cancel`)?.addEventListener(`click`,()=>j.navigate(`/inventory`)),a?.addEventListener(`submit`,async i=>{i.preventDefault();let a={name:e.querySelector(`#product-name`).value.trim(),barcode:e.querySelector(`#product-barcode`).value.trim(),categoryId:parseInt(e.querySelector(`#product-category`).value),purchasePrice:parseFloat(e.querySelector(`#product-purchase`).value)||0,salePrice:parseFloat(e.querySelector(`#product-sale`).value)||0,stock:n?r.stock:parseInt(e.querySelector(`#product-stock`).value)||0,minStock:parseInt(e.querySelector(`#product-minstock`).value)||5,unit:e.querySelector(`#product-unit`).value,supplier:e.querySelector(`#product-supplier`).value.trim(),notes:e.querySelector(`#product-notes`).value.trim()};if(!a.name){R(`error`,`Nombre requerido`);return}if(!a.categoryId){R(`error`,`Selecciona una categoría`);return}try{n?(await w.update(parseInt(t.id),a),R(`success`,`Producto actualizado`,a.name)):(await w.create(a),R(`success`,`Producto creado`,a.name)),j.navigate(`/inventory`)}catch(e){R(`error`,`Error`,e.message)}})}async function ze(e){let t=await E.getAllIncludeInactive();for(let e of t)e.productCount=await E.getProductCount(e.id);e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
  ...
  `,e.querySelector(`#add-category-btn`)?.addEventListener(`click`,()=>{Be(null,e)}),e.querySelectorAll(`.edit-cat-btn`).forEach(t=>{t.addEventListener(`click`,async n=>{n.stopPropagation(),Be(await E.getById(parseInt(t.dataset.id)),e)})}),e.querySelectorAll(`.delete-cat-btn`).forEach(t=>{t.addEventListener(`click`,async n=>{n.stopPropagation();let r=parseInt(t.dataset.id);if(await De({title:`¿Eliminar categoría?`,message:`Se eliminará "${(await E.getById(r)).name}". Los productos sin categoría quedarán sin asignar.`,type:`danger`,confirmText:`Eliminar`}))try{await E.delete(r),R(`success`,`Categoría eliminada`),await ze(e)}catch(e){R(`error`,`No se pudo eliminar`,e.message)}})})}function Be(e,t){let n=!!e,r=e?.color||ge[0],i=`
    <div class="form-group" style="margin-bottom: var(--space-lg);">
  ...
  `,o=Ee({title:n?`Editar Categoría`:`Nueva Categoría`,content:i,footer:a,size:`sm`});o.element.querySelectorAll(`.color-option`).forEach(e=>{e.addEventListener(`click`,()=>{o.element.querySelectorAll(`.color-option`).forEach(e=>e.style.borderColor=`transparent`),e.style.borderColor=`var(--text-primary)`,r=e.dataset.color})}),o.element.querySelector(`#cat-cancel`).addEventListener(`click`,()=>o.close()),o.element.querySelector(`#cat-save`).addEventListener(`click`,async()=>{let i=o.element.querySelector(`#cat-name`).value.trim();if(!i){R(`error`,`Nombre requerido`);return}try{n?(await E.update(e.id,{name:i,color:r}),R(`success`,`Categoría actualizada`)):(await E.create({name:i,color:r}),R(`success`,`Categoría creada`)),o.close(),await ze(t)}catch(e){R(`error`,`Error`,e.message)}})}async function Ve(e){let t=await T.getAll(),n=await w.getAll({showInactive:!0}),r=await D.getAll(),i={};n.forEach(e=>{i[e.id]=e});let a={};r.forEach(e=>{a[e.id]=e});let o=t.map(e=>({...e,productName:i[e.productId]?.name||`Eliminado`,productUnit:i[e.productId]?.unit||`pzas`,userName:a[e.userId]?.name||`—`})),s=o.filter(e=>e.type===`entry`).reduce((e,t)=>e+t.quantity,0),c=o.filter(e=>e.type===`exit`).reduce((e,t)=>e+t.quantity,0);e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
            ...
            ${o.map(e=>`
              <tr>
                ...
                <td style="font-size: var(--font-size-sm); color: var(--text-secondary);">
                  <span data-tooltip="${ue(e.createdAt)}">${F(e.createdAt)}</span>
                </td>
              </tr>
            `).join(``)}
          </tbody>
    ...
    `}
  `}async function He(e){if(!A.isOwner()){e.innerHTML=`
  ...
  `,e.querySelector(`#add-user-btn`)?.addEventListener(`click`,()=>{Ue(null,e)}),e.querySelectorAll(`.edit-user-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{Ue(await D.getById(parseInt(t.dataset.id)),e)})}),e.querySelectorAll(`.toggle-user-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let n=parseInt(t.dataset.id),r=await D.getById(n);r.active?await De({title:`¿Desactivar usuario?`,message:`${r.name} no podrá acceder a la app.`,type:`warning`,confirmText:`Desactivar`})&&(await D.update(n,{active:!1}),R(`success`,`Usuario desactivado`),await He(e)):(await D.update(n,{active:!0}),R(`success`,`Usuario activado`),await He(e))})})}function Ue(e,t){let n=!!e,r=`
    <div class="form-group" style="margin-bottom: var(--space-md);">
  ...
  `,a=Ee({title:n?`Editar Empleado`:`Nuevo Empleado`,content:r,footer:i,size:`sm`});a.element.querySelector(`#user-cancel`).addEventListener(`click`,()=>a.close()),a.element.querySelector(`#user-save`).addEventListener(`click`,async()=>{let r=a.element.querySelector(`#user-name`).value.trim(),i=a.element.querySelector(`#user-pin`).value.trim();if(!r){R(`error`,`Nombre requerido`);return}if(!n&&(!i||i.length!==4||!/^\d{4}$/.test(i))){R(`error`,`PIN inválido`,`Debe ser de 4 dígitos numéricos`);return}if(n&&i&&(i.length!==4||!/^\d{4}$/.test(i))){R(`error`,`PIN inválido`,`Debe ser de 4 dígitos numéricos`);return}try{if(n){let t={name:r};i&&(t.pin=i),await D.update(e.id,t),R(`success`,`Empleado actualizado`)}else await D.create({name:r,pin:i,role:`employee`}),R(`success`,`Empleado creado`,`PIN: ${i}`);a.close(),await He(t)}catch(e){R(`error`,`Error`,e.message)}})}async function U(e){let t=await O.getAll();e.innerHTML=`
    <div class="page-header fade-in-up">
      <div class="page-header-info">
  ...
  `;function n(){let t=e.querySelector(`#connection-status`),n=e.querySelector(`#connection-text`);t&&n&&(navigator.onLine?(t.style.background=`var(--success)`,n.textContent=`Conectado`):(t.style.background=`var(--warning)`,n.textContent=`Sin conexión — datos guardados localmente`))}n(),window.addEventListener(`online`,n),window.addEventListener(`offline`,n),e.querySelector(`#save-settings-btn`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#setting-store-name`).value.trim(),n=e.querySelector(`#setting-owner-name`).value.trim();await O.set(`storeName`,t||`Doña Marian`),await O.set(`ownerName`,n),R(`success`,`Configuración guardada`);let r=document.querySelector(`.sidebar-brand-name`);r&&(r.textContent=t||`Doña Marian`)}),e.querySelector(`#export-backup-btn`)?.addEventListener(`click`,async()=>{try{let e=await O.exportAll(),t=new Date().toISOString().split(`T`)[0];fe(e,`dona_marian_backup_${t}.json`,`application/json`),R(`success`,`Respaldo exportado`,`Guarda este archivo en un lugar seguro`)}catch(e){R(`error`,`Error al exportar`,e.message)}}),e.querySelector(`#import-backup-btn`)?.addEventListener(`click`,async()=>{try{if(!await showConfirm({title:`¿Restaurar respaldo?`,message:`Se borrarán todos los datos actuales y se reemplazarán por los del archivo seleccionado. Esta acción no se puede deshacer.`,type:`warning`,confirmText:`Restaurar Todo`}))return;let e=await pe(`.json`);await O.importAll(e),R(`success`,`Respaldo restaurado`,`Se recargará la app...`),setTimeout(()=>location.reload(),1500)}catch(e){e.message!==`No se seleccionó archivo`&&R(`error`,`Error al importar`,e.message)}}),e.querySelector(`#export-csv-btn`)?.addEventListener(`click`,async()=>{try{let e=await O.exportCSV(),t=new Date().toISOString().split(`T`)[0];fe(e,`inventario_dona_marian_${t}.csv`,`text/csv`),R(`success`,`CSV exportado`)}catch(e){R(`error`,`Error al exportar`,e.message)}}),e.querySelector(`#settings-logout-btn`)?.addEventListener(`click`,()=>{A.logout(),router.navigate(`/login`)})}function W(){let e=A.getUser(),t=document.getElementById(`app`);t.innerHTML=`
...
`,document.head.appendChild(Ke),Ge();export{o as n,l as r,N as t};